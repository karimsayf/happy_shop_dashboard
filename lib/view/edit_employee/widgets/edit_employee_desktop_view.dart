...
class EditEmployeeDesktopView extends StatefulWidget {
  const EditEmployeeDesktopView({super.key});

  @override
  State<EditEmployeeDesktopView> createState() => _EditEmployeeDesktopViewState();
}

class _EditEmployeeDesktopViewState extends State<EditEmployeeDesktopView> {
          ...
          children: [
            Row(
              children: [
                ...
                const Text('/',style: TextStyle(color: AppColors.mainColor,fontSize: 13),),
                const SizedBox(width: 10,),
                const Text('تعديل موظف',style: TextStyle(color: Colors.grey,fontSize: 13),),
              ],
            ),
            _buildDivider(),
            const Text(
