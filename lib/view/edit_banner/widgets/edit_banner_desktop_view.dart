...
class EditBannerDesktopView extends StatefulWidget {
  const EditBannerDesktopView({super.key});

  @override
  State<EditBannerDesktopView> createState() => _EditBannerDesktopViewState();
}

class _EditBannerDesktopViewState extends State<EditBannerDesktopView> {
