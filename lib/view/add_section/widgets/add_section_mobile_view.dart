...
class AddSectionMobileView extends StatefulWidget {
  const AddSectionMobileView({super.key});

  @override
  State<AddSectionMobileView> createState() => _AddSectionMobileViewState();
}

class _AddSectionMobileViewState extends State<AddSectionMobileView> {
        ...
        child: Column(
          ...
          children: [
            ...
            Row(
              ...
              children: [
                InkWell(
                  onTap: Provider.of<AddSectionViewModel>(context).loading
                      ? () {}
                      : () async {
                          await Provider.of<AddSectionViewModel>(context,
                                  listen: false)
                              .addSection(context);
                        },
                  ...
                  child: Container(
                    ...
                    height: 40,
                    width: 120,
                    child: Provider.of<AddSectionViewModel>(context).loading
                        ? const Center(
