...
class AddProductDesktopView extends StatefulWidget {
  const AddProductDesktopView({super.key});

  @override
  State<AddProductDesktopView> createState() => _AddProductDesktopViewState();
}

class _AddProductDesktopViewState extends State<AddProductDesktopView> {
