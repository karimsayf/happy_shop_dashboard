...
class AddMainSizeMobileView extends StatefulWidget {
  const AddMainSizeMobileView({super.key});

  @override
  State<AddMainSizeMobileView> createState() => _AddMainSizeMobileViewState();
}
