...
class EditSectionDesktopView extends StatefulWidget {
  const EditSectionDesktopView({super.key});

  @override
  State<EditSectionDesktopView> createState() => _EditSectionDesktopViewState();
}

class _EditSectionDesktopViewState extends State<EditSectionDesktopView> {
