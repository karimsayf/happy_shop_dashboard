...
class AddProductColorDesktopView extends StatefulWidget {
  const AddProductColorDesktopView({super.key});

  @override
  State<AddProductColorDesktopView> createState() => _AddProductColorDesktopViewState();
}

class _AddProductColorDesktopViewState extends State<AddProductColorDesktopView> {
