...
class AddCityMobileView extends StatefulWidget {
  const AddCityMobileView({super.key});

  @override
  State<AddCityMobileView> createState() => _AddCityMobileViewState();
}

class _AddCityMobileViewState extends State<AddCityMobileView> {
