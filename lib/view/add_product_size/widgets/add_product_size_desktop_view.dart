...
class AddProductSizeDesktopView extends StatefulWidget {
  const AddProductSizeDesktopView({super.key});

  @override
  State<AddProductSizeDesktopView> createState() => _AddProductSizeDesktopViewState();
}

class _AddProductSizeDesktopViewState extends State<AddProductSizeDesktopView> {
