...
class AddBannerMobileView extends StatefulWidget {
  const AddBannerMobileView({super.key});

  @override
  State<AddBannerMobileView> createState() => _AddBannerMobileViewState();
}

class _AddBannerMobileViewState extends State<AddBannerMobileView> {
        ...
        child: Column(
          ...
          children: [
            ...
            Row(
              ...
              children: [
                InkWell(
                  onTap: Provider.of<AddBannerViewModel>(context).loading
                      ? () {}
                      : () async {
                          await Provider.of<AddBannerViewModel>(context,
                                  listen: false)
                              .addBanner(context);
                        },
                  ...
                  child: Container(
                    ...
                    height: 40,
                    width: 120,
                    child: Provider.of<AddBannerViewModel>(context).loading
                        ? const Center(
