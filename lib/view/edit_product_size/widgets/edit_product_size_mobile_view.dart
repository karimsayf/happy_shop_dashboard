...
class EditProductSizeMobileView extends StatefulWidget {
  const EditProductSizeMobileView({super.key});

  @override
  State<EditProductSizeMobileView> createState() => _EditProductSizeMobileViewState();
}

class _EditProductSizeMobileViewState extends State<EditProductSizeMobileView> {
